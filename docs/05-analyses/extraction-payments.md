...
**Verrouiller aussi les sept acquis des bacs à sable, documentés dans `docs/03-services/billing/05-providers.md`, chacun par un test nommé d'après le démenti.** Ils sont incarnés par du code qui, lu hors contexte, passe pour du bruit :
