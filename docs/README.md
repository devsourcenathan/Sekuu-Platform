...
| Verify | À spécifier | — |
| **Payments** | **Implémenté** — Notch Pay, Tranzak | [vision](03-services/payments/01-overview.md) · [intégrer un module](03-services/payments/06-integration.md) · [**service externe**](03-services/payments/07-external-api.md) *(spécifié)* · [agrégateurs](03-services/payments/05-providers.md) · [contrat OpenAPI](../Modules/Payments/openapi.yaml) |
